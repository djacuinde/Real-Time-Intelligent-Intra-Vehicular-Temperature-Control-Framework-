...
endTime = 0.0
elapseTime = 0.0
setTime = 30.0 #seconds

#Detection
detectIterations = 0.0
DOG_Stat = 0
CAT_Stat = 0
PERSON_Stat = 0
...
while(!detectResult):
    ...
    else if((DOG_Final > confidenceThreshold  | CAT_Final > confidenceThreshold)  & PERSON_Final < confidenceThreshold ):
        #pet is detected
        detectResult = True
    else :
        detectResult = False
...
def readDTH(Degree):
    ...
    if humidity is not None and temperature is not None:
        ...
        if Degree is 'F':
            newTemp = 9/5.0*temperature+32
            print("Temp = {0:0.1f} F ; Humidity = {1:0.1f}%".format(newTemperature, humidity))
